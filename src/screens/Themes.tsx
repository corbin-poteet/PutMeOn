...
const Themes = () => {
  ...
  const themeList = [
    ...
    { id: '10', label: 'Contrast', colors: ['#000000', '#000000'], labelColor: '#0000ff' },
    { id: '11', label: 'Midnight', colors: ['#000000', '#1541d8'] },
    { id: '12', label: 'Spectre', colors: ['#000000', '#0000'] },
    { id: '13', label: 'Desktop', colors: ['#8dbcf4', '#6e9123'] },
    { id: '14', label: 'Kokomo', colors: ['#ab7d4a', '#64155b'] },
    { id: '15', label: 'Retro', colors: ['#0f011a', '#1e146e'], labelColor: '#03e7fb' },
    { id: '16', label: 'Gilded', colors: ['#ffb302', '#7a5e39'] },
    { id: '17', label: 'Ink', colors: ['#000000', '#000000'] },
